...
return [
    ...
    */
    'repositories' => [
        ...
        'token_list' => [
            'store'                => 'default',
            'repository_interface' => \Prooph\ProophessorDo\Model\AccessToken\TokenList::class,
            'repository_class'     => \Prooph\ProophessorDo\Infrastructure\Repository\EventStoreTokenList::class,
            'aggregate_type'       => \Prooph\ProophessorDo\Model\AccessToken\AccessToken::class,
        ],
        'message_list' => [
            'store'                => 'default',
            'repository_interface' => \Prooph\ProophessorDo\Model\Message\MessageList::class,
            'repository_class'     => \Prooph\ProophessorDo\Infrastructure\Repository\EventStoreMessageList::class,
            'aggregate_type'       => \Prooph\ProophessorDo\Model\Message\Message::class,
        ],
         'group_collection' => [
            'store'                => 'default',
            'repository_interface' => \Prooph\ProophessorDo\Model\Group\GroupCollection::class,
            'repository_class'     => \Prooph\ProophessorDo\Infrastructure\Repository\EventStoreGroupCollection::class,
            'aggregate_type'       => \Prooph\ProophessorDo\Model\Group\Group::class,
        ],
    ],
    ...
    'projection_managers' => [
        'todo_projection_manager' => [
            ...
            'projections' => [
                ...
                'group_projection' => [
                    'read_model' => \Prooph\ProophessorDo\Projection\Group\GroupReadModel::class,
                    'projection' => \Prooph\ProophessorDo\Projection\Group\GroupProjection::class,
                ],
