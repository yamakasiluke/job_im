...
class SendMessageToGroupMembersProcessManager
{
    /**
     * @var CommandBus
     */
    ...
    public function __invoke(SendMessageToGroup $event): void
    {
        $this->commandBus->dispatch(SendMessageToGroupMemberCommand::withData(
            $event->receiverId(),
            $event->messageText(),
            $event->messageId(),
        ));
