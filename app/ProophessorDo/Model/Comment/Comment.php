...
final class Comment extends AggregateRoot implements Entity
{
    /**
     * @var UserId
     */
    ...
    public function MakeComment():void{} // user circle order goods
    protected function WhenMakeComment(): void {}
