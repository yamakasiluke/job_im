...
final class WantBuyGoods extends AggregateRoot implements Entity
{
...
//        $self->recordThat(UserWasRegistered::withData($$userId));
    ...
    public function PublishWantBuyGoods():void{}
    protected function WhenPublishWantBuyGoods(): void {}
