...
namespace Prooph\ProophessorDo\Model\Relationship;
...
use Prooph\ProophessorDo\Model\Relationship\Event\UserWasRegistered;
use Prooph\ProophessorDo\Model\Relationship\Event\BlockFriend;

final class Relationship extends AggregateRoot implements Entity
{
    /**
     * @var UserId
     */
    ...
    private $initiativeUserId;
    private $status;
    private $firstUserId;
    private $secondUserId;


    public function MakeFriend():void{}
    protected function WhenMakeFriend(): void {}

    public function InviteFriend():void{}
    protected function WhenInviteFriend(): void {}
